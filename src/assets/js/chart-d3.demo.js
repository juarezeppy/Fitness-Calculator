...
var handleD3LineChart = function() {
    "use strict";
...
var handleD3PieAndDonutChart = function() {
    "use strict";
...
var handleD3StackedAreaChart = function() {
    "use strict";
...
var handleD3StackedBarChart = function() {
    "use strict";
    ...
    return {
        ...
        init: function () {
            $.getScript('https://cdnjs.cloudflare.com/ajax/libs/d3/3.5.2/d3.min.js').done(function() {
                $.getScript('assets/plugins/nvd3/build/nv.d3.js').done(function() {
                    handleD3LineChart();
                    handleD3BarChart();
                    handleD3PieAndDonutChart();
                    handleD3StackedAreaChart();
                    handleD3StackedBarChart();
                });
            });
        }
    };
